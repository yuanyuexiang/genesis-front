    ...
    <div class="animated fadeIn">
        ...
        <Row>
            ...
            <div class="highlight" style="background: #f0f0f0">
                <pre style="line-height: 125%"><span style="color: #062873; font-weight: bold">&lt;template&gt;</span>
    ...
    return {
      ...
      sampleData1: {
        ...
        labs: [
          ...
          { name: "BNP", time: "3 Weeks", location: "Primary Care Clinic" },
          ...
          { name: "Creatinine", time: "1 Year", location: "Main Hospital Lab" },
          {
          ...
          { name: "PT/INR", time: "3 Weeks", location: "Primary Care Clinic" },
          { name: "PTT", time: "3 Weeks", location: "Coumadin Clinic" },
          { name: "TSH", time: "1 Year", location: "Primary Care Clinic" }
        ],
        imaging: [
          {
            name: "Chest X-Ray",
