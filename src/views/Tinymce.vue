<template>
    <div class="components-container">
        ...
        <h3 class="intro-head">
            <a href="https://github.com/lpreterite/vue-tinymce" target="_blank">vue-tinymce</a>
        </h3>
        <p class="intro-head">作者的原项目有一些bug，自己改进一个临时的 </p>

        <Row :gutter="20">
            <Col :span="12">
            <vue-tinymce ref="tinymce" v-model="content1" :setting="setting1">
            </vue-tinymce>
            </Col>
            <Col span="12">
            <vue-tinymce ref="tinymce" v-model="content2" :setting="setting2">
            </vue-tinymce>
            </Col>
        </Row>
...
export default {
  ...
  data() {
    return {
      ...
      content2:
        '<p>Tinymce inlite主题</p><hr><p>这里输入时回车可快速插入选择本地图片和表格 <img src="//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/19/heia_thumb.gif" data-key="[哈哈]"></img></p>',
    ...
    insertImg(editor, { path, key }) {
      editor.undoManager.transact(function() {
        ...
        editor.selection.setContent(
          editor.dom.createHTML("img", { src: path, "data-key": key })
        );
      });
    },
